/**
 * @fileoverview Controller for handling "what to ask" suggestions using RAG system
 */
...
/**
 * Handles "what to ask" suggestions stream
...
export async function handleWhatToAskController(req, res) {
  try {
    ...
    // Create vector stores and initialize query engine
    ...
    // Create combined retriever filters
    const filters = {
    ...
    console.error("Error in handleWhatToAskController:", error);
